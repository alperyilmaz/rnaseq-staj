...
rule download:
    output:
       "fastqdump/{sample}_1.fastq.gz",
       "fastqdump/{sample}_2.fastq.gz"
    conda:
       "envs/sratools.yaml"
    shell:
       "fastq-dump -N 0 -X 2000000 -O fastqdump/ --split-files --gzip {wildcards.sample}"
...
rule starmap:
     input:
         r1="fastqdump/{sample}_1.fastq.gz",
         r2="fastqdump/{sample}_2.fastq.gz",
